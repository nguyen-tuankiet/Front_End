            ...
            <div className="flex flex-col md:flex-row gap-3">
                ...
                <div className="relative">
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-300 rounded-lg hover:border-primary transition-colors min-w-[120px] justify-between"
                    >
                        <span className="text-sm font-medium text-gray-700">{selectedCategoryLabel}</span>
                ...
                <div className="relative">
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-300 rounded-lg hover:border-primary transition-colors min-w-[150px] justify-between"
                    >
                        <Calendar className="w-4 h-4 text-gray-400" />
                        <span className="text-sm font-medium text-gray-700">{selectedTimeLabel}</span>
                        <ChevronDown className={cn(
                            "w-4 h-4 text-gray-400 transition-transform",
